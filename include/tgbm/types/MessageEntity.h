...
class MessageEntity {
 public:
   ...
   *
   * Currently, can be Type::Mention (@username), Type::Hashtag (#hashtag), Type::Cashtag ($USD),
   * Type::BotCommand (/start@jobs_bot), Type::Url (https://telegram.org), Type::Email
   * (do-not-reply@telegram.org), Type::PhoneNumber (+1-212-555-0123), Type::Bold (bold text), Type::Italic
   * (italic text), Type::Underline (underlined text), Type::Strikethrough (strikethrough text), Type::Spoiler
   * (spoiler message), Type::Blockquote (block quotation), Type::Code (monowidth string), Type::Pre
   * (monowidth block), Type::TextLink (for clickable text URLs), Type::TextMention (for users [without
   * usernames](https://telegram.org/blog/edit#new-mentions)), Type::CustomEmoji (for inline custom emoji
   * stickers)
   */
  Type type;

  /**
   * @brief Offset in [UTF-16 code units](https://core.telegram.org/api/entities#entity-length) to the start
   * of the entity
   *
   */
  std::int32_t offset;
