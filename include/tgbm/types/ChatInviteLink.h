...
class ChatInviteLink {
 public:
   ...
   * If the link was created by another chat administrator, then the second part of the link will be replaced
   * with “…”.
   */
  ...
  /**
   * @brief Optional. Maximum number of users that can be members of the chat simultaneously after joining the
