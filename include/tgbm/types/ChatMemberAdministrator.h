...
class ChatMemberAdministrator : public ChatMember {
 public:
  ...
  /**
   * @brief True, if the administrator can access the chat event log, get boost list, see hidden supergroup
  ...
  /**
   * @brief True, if the administrator can add new administrators with a subset of their own privileges or
   * demote administrators that they have promoted, directly or indirectly (promoted by administrators that
  ...
  /**
   * @brief Optional. True, if the administrator can post messages in the channel, or access channel
   * statistics; for channels only
   */
  bool canPostMessages;

  /**
   * @brief Optional. True, if the administrator can edit messages of other users and can pin messages; for
   * channels only
   */
  ...
  /**
   * @brief Optional. True, if the user is allowed to create, rename, close, and reopen forum topics; for
   * supergroups only
   */
