...
class InputSticker {
 public:
   ...
   * a String for Telegram to get a file from the Internet, upload a new one using multipart/form-data, or
  ...
  /**
   * @brief Format of the added sticker, must be one of “static” for a .WEBP or .PNG image, “animated” for a
