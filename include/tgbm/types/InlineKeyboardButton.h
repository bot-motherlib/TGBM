...
class InlineKeyboardButton {
 public:
  ...
  /**
   * @brief Optional. Data to be sent in a [callback query](https://core.telegram.org/bots/api#callbackquery)
   * to the bot when button is pressed, 1-64 bytes
   */
  std::string callbackData;

  /**
   * @brief Optional. Description of the [Web App](https://core.telegram.org/bots/webapps) that will be
   * launched when the user presses the button.
   *
   * The Web App will be able to send an arbitrary message on behalf of the user using the method
   * Api::answerWebAppQuery. Available only in private chats between a user and the bot.
   */
  ...
  /**
   * @brief Optional. If set, pressing the button will insert the bot's username and the specified inline
  ...
  /**
   * @brief Optional. If set, pressing the button will prompt the user to select one of their chats of the
   * specified type, open that chat and insert the bot's username and the specified inline query in the input
   * field
   */
