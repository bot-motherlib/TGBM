...
class LinkPreviewOptions {
 public:
  ...
  /**
   * @brief Optional. True, if the media in the link preview is supposed to be shrunk; ignored if the URL
   * isn't explicitly specified or media size change isn't supported for the preview
   */
  bool preferSmallMedia;

  /**
   * @brief Optional. True, if the media in the link preview is supposed to be enlarged; ignored if the URL
   * isn't explicitly specified or media size change isn't supported for the preview
   */
  bool preferLargeMedia;

  /**
   * @brief Optional. True, if the link preview must be shown above the message text; otherwise, the link
