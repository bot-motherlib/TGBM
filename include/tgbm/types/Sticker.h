...
class Sticker {
 public:
   ...
   * The type of the sticker is independent from its format, which is determined by the fields isAnimated and
   * isVideo.
   */
  Type type;
  ...
  /**
   * @brief Optional. True, if the sticker must be repainted to a text color in messages, the color of the
   * Telegram Premium badge in emoji status, white color on chat photos, or another appropriate color in other
   * places
   */
