 ...
 * user. Serves as a great replacement for the Telegram Login Widget when the user is coming from Telegram.
...
class LoginUrl {
 public:
  ...
  /**
   * @brief An HTTP URL to be opened with user authorization data added to the query string when the button is
   ...
   * of the data as described in https://core.telegram.org/widgets/login#checking-authorization
   */
  std::string url;
