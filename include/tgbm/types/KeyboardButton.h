 ...
 * The optional fields KeyboardButton::webApp, KeyboardButton::requestUsers, KeyboardButton::requestChat,
 * KeyboardButton::requestContact, KeyboardButton::requestLocation, and KeyboardButton::requestPoll are
 * mutually exclusive.
 *
 * Note: KeyboardButton::requestUsers and KeyboardButton::requestChat options will only work in Telegram
 * versions released after 3 February, 2023. Older clients will display unsupported message.
 *
 * @ingroup types
 */
class KeyboardButton {
 public:
  ...
  /**
   * @brief Optional. If specified, the user will be asked to create a poll and send it to the bot when the
   * button is pressed.
   *
   * Available in private chats only.
   */
  ...
  /**
   * @brief Optional. If specified, the described [Web App](https://core.telegram.org/bots/webapps) will be
   * launched when the button is pressed.
   *
