...
class Giveaway {
 public:
  ...
  /**
   * @brief Optional. True, if only users who join the chats after the giveaway started should be eligible to
   * win
   */
  bool onlyNewMembers;
  ...
  /**
   * @brief Optional. A list of two-letter [ISO 3166-1
   * alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country codes indicating the countries from
   * which eligible users for the giveaway must come.
   *
  ...
  /**
   * @brief Optional. The number of months the Telegram Premium subscription won from the giveaway will be
   * active for
   */
