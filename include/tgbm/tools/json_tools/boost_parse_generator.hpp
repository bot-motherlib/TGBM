...
// void log_event_helper(std::string_view func, Args&&... args) {
//   std::string fmt_str = "{}";
//   for (std::size_t i = 0; i < sizeof...(args); i++) {
//     fmt_str.append(" [{}]");
//   }
//   fmt_str.append("\n");
//   ::fmt ::vformat_to(::std::ostreambuf_iterator(std ::cout), fmt_str, fmt::make_format_args(func,
//   args...));
// }

// #define $log_event(...) log_event_helper(__PRETTY_FUNCTION__ __VA_OPT__(, ) __VA_ARGS__)
#define $log_event(...)
