 ...
 * provider from whom they acquired Stars (e.g., Apple, Google) following this transaction, the refunded Stars
 * will be deducted from the bot's balance. This is outside of Telegram's control.*/
