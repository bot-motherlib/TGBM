...
struct SuggestedPostPrice {
   ...
   * Telegram Stars or nanograms. Currently, price in Telegram Stars must be between 5 and 100000, and price
  ...
  bool operator==(const SuggestedPostPrice&) const;
  std::strong_ordering operator<=>(const SuggestedPostPrice&) const;
};
