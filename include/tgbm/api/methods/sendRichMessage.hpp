...
struct send_rich_message_request {
  ...
  /* Unique identifier of the business connection on behalf of which the message will be sent. Bot can send
   * rich messages on behalf of a business account only if the corresponding user can send rich messages. */
  ...
  static constexpr std::string_view api_method_name = "sendRichMessage";
