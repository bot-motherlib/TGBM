...
class ReplyKeyboardRemove : public GenericReply {
 public:
  ...
  /**
   * @brief Requests clients to remove the custom keyboard (user will not be able to summon this keyboard; if
   * you want to hide the keyboard from sight but keep it accessible, use oneTimeKeyboard in
   * ReplyKeyboardMarkup)
   */
  bool removeKeyboard;
