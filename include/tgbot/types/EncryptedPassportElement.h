...
class EncryptedPassportElement {
 public:
  ...
  /**
   * @brief Optional. Base64-encoded encrypted Telegram Passport element data provided by the user; available
  ...
  /**
   * @brief Optional. Array of encrypted files with documents provided by the user; available only for
  ...
  /**
   * @brief Optional. Encrypted file with the front side of the document, provided by the user; available only
  ...
  /**
   * @brief Optional. Encrypted file with the reverse side of the document, provided by the user; available
   * only for “driver_license” and “identity_card”.
   *
   * The file can be decrypted and verified using the accompanying EncryptedCredentials.
   */
  ...
  /**
   * @brief Optional. Encrypted file with the selfie of the user holding a document, provided by the user;
