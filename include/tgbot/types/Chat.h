...
class Chat {
 public:
   ...
   * usernames](https://telegram.org/blog/topics-in-groups-collectible-usernames#collectible-usernames); for
  ...
  /**
   * @brief Optional. Identifier of the accent color for the chat name and backgrounds of the chat photo,
  ...
  /**
   * @brief Optional. Custom emoji identifier of emoji chosen by the chat for the reply header and link
   * preview background.
   *
   * Returned only in Api::getChat.
   */
  ...
  /**
   * @brief Optional. Custom emoji identifier of the emoji status of the chat or the other party in a private
   * chat.
   *
   * Returned only in Api::getChat.
   */
  ...
  /**
   * @brief Optional. Expiration date of the emoji status of the chat or the other party in a private chat, in
   * Unix time, if any.
   *
   * Returned only in Api::getChat.
   */
  ...
  /**
   * @brief Optional. True, if the privacy settings of the other party restrict sending voice and video note
  ...
  /**
   * @brief Optional. True, if all users directly joining the supergroup need to be approved by supergroup
   * administrators.
   *
   * Returned only in Api::getChat.
   */
  ...
  /**
   * @brief Optional. For supergroups, the minimum allowed delay between consecutive messages sent by each
  ...
  /**
   * @brief Optional. For supergroups, the minimum number of boosts that a non-administrator user needs to add
  ...
  /**
   * @brief Optional. The time after which all messages sent to the chat will be automatically deleted; in
   * seconds.
   *
   * Returned only in Api::getChat.
   */
  ...
  /**
   * @brief Optional. True, if non-administrators can only get the list of bots and administrators in the
   * chat.
   *
   * Returned only in Api::getChat.
   */
  ...
  /**
   * @brief Optional. True, if new chat members will have access to old messages; available only to chat
   * administrators.
   *
   * Returned only in Api::getChat.
   */
  ...
  /**
   * @brief Optional. Unique identifier for the linked chat, i.e. the discussion group identifier for a
   * channel and vice versa; for supergroups and channel chats.
   *
   * This identifier may be greater than 32 bits and some programming languages may have difficulty/silent
   * defects in interpreting it. But it is smaller than 52 bits, so a signed 64 bit integer or
   * double-precision float type are safe for storing this identifier. Returned only in Api::getChat.
   */
