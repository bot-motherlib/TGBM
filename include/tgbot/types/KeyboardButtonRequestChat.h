...
class KeyboardButtonRequestChat {
 public:
  ...
  /**
   * @brief Optional. Pass True to request a supergroup or a channel with a username, pass False to request a
   * chat without a username.
   *
   * If not specified, no additional restrictions are applied.
   */
  ...
  /**
   * @brief Optional. A JSON-serialized object listing the required administrator rights of the user in the
   * chat.
   *
  ...
  /**
   * @brief Optional. A JSON-serialized object listing the required administrator rights of the bot in the
   * chat.
   *
