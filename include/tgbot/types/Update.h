...
class Update {
 public:
   ...
   * [webhooks](https://core.telegram.org/bots/api#setwebhook), since it allows you to ignore repeated updates
   * or to restore the correct update sequence, should they get out of order. If there are no new updates for
   ...
   *
   * This update may at times be triggered by changes to message fields that are either unavailable or not
  ...
  /**
   * @brief Optional. The bot was connected to or disconnected from a business account, or a user edited an
   ...
   * of allowedUpdates to receive these updates. The update isn't received for reactions set by bots.
   */
   ...
   * list of allowedUpdates to receive these updates. The updates are grouped and can be sent with delay up to
   * a few minutes.
   */
  ...
  /**
   * @brief Optional. The result of an [inline](https://core.telegram.org/bots/api#inline-mode) query that was
   ...
   * allowedUpdates to receive these updates.
   */
