...
class User {
 public:
   ...
   * difficulty/silent defects in interpreting it. But it has at most 52 significant bits, so a 64-bit integer
  ...
  /**
   * @brief Optional. [IETF language tag](https://en.wikipedia.org/wiki/IETF_language_tag) of the user's
   * language
   */
  ...
  /**
   * @brief Optional. True, if [privacy mode](https://core.telegram.org/bots/features#privacy-mode) is
  ...
  /**
   * @brief Optional. True, if the bot can be connected to a Telegram Business account to receive its
   * messages.
   *
   * Returned only in Api::getMe.
   */
