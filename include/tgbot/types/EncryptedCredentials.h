 ...
 * See https://core.telegram.org/passport#receiving-information for a complete description of the data
...
class EncryptedCredentials {
 public:
  ...
  /**
   * @brief Base64-encoded encrypted JSON-serialized data with unique user's payload, data hashes and secrets
   * required for @ref EncryptedPassportElement decryption and authentication
   */
  std::string data;
