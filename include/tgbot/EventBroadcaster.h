...
class TGBOT_API EventBroadcaster {
 ...
 public:
   ...
   */
  inline void onCommand(const std::initializer_list<std::string>& commandsList,
  ...
  /**
   * @brief Registers listener which receives all messages with commands (messages with leading '/' char)
   * which haven't been handled by other listeners.
   * @param listener Listener.
   */
  ...
  /**
   * @brief Registers listener which receives all messages without commands (messages with no leading '/'
   * char)
   * @param listener Listener.
   */
  ...
  /**
   * @brief Registers listener which receives new versions of a message that is known to the bot and was
   * edited
   * @param listener Listener.
   */
  ...
  /**
   * @brief Registers listener which receives the results of an inline query that was chosen by a user and
   * sent to their chat partner. Please see https://core.telegram.org/bots/inline#collecting-feedback for
  ...
  /**
   * @brief Registers listener which receives an answer if a user changed their answer in a non-anonymous
