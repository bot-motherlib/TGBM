...
template <typename T>
inline std::string diff(const T& test, const T& expected,
                        std::string (*toStringFunc)(const typename T::value_type&)) {
  std::string result;
  result += "\n*** BEGIN ***	 Count: t=";
...
inline std::string diffS(const std::string& test, const std::string& expected) {
  ...
  std::string (*toStringFunc)(const std::string&) = [](const std::string& item) -> std::string {
    return item;
  };
...
inline std::string diffMSS(const std::unordered_map<std::string, std::string>& test,
  ...
  std::string (*toStringFunc)(const std::pair<const std::string, std::string>&) =
      [](const std::pair<const std::string, std::string>& item) -> std::string {
