...
Update::Ptr TgTypeParser::parseJsonAndGetUpdate(const boost::property_tree::ptree& data) const {
  ...
  result->editedMessage =
      tryParseJson<Message>(&TgTypeParser::parseJsonAndGetMessage, data, "edited_message");
  result->channelPost = tryParseJson<Message>(&TgTypeParser::parseJsonAndGetMessage, data, "channel_post");
  result->editedChannelPost =
      tryParseJson<Message>(&TgTypeParser::parseJsonAndGetMessage, data, "edited_channel_post");
  result->businessConnection = tryParseJson<BusinessConnection>(
      &TgTypeParser::parseJsonAndGetBusinessConnection, data, "business_connection");
  result->businessMessage =
      tryParseJson<Message>(&TgTypeParser::parseJsonAndGetMessage, data, "business_message");
  result->editedBusinessMessage =
      tryParseJson<Message>(&TgTypeParser::parseJsonAndGetMessage, data, "edited_business_message");
  result->deletedBusinessMessages = tryParseJson<BusinessMessagesDeleted>(
      &TgTypeParser::parseJsonAndGetBusinessMessagesDeleted, data, "deleted_business_messages");
  result->messageReaction = tryParseJson<MessageReactionUpdated>(
      &TgTypeParser::parseJsonAndGetMessageReactionUpdated, data, "message_reaction");
  result->messageReactionCount = tryParseJson<MessageReactionCountUpdated>(
      &TgTypeParser::parseJsonAndGetMessageReactionCountUpdated, data, "message_reaction_count");
  result->inlineQuery =
      tryParseJson<InlineQuery>(&TgTypeParser::parseJsonAndGetInlineQuery, data, "inline_query");
  result->chosenInlineResult = tryParseJson<ChosenInlineResult>(
      &TgTypeParser::parseJsonAndGetChosenInlineResult, data, "chosen_inline_result");
  result->callbackQuery =
      tryParseJson<CallbackQuery>(&TgTypeParser::parseJsonAndGetCallbackQuery, data, "callback_query");
  result->shippingQuery =
      tryParseJson<ShippingQuery>(&TgTypeParser::parseJsonAndGetShippingQuery, data, "shipping_query");
  result->preCheckoutQuery = tryParseJson<PreCheckoutQuery>(&TgTypeParser::parseJsonAndGetPreCheckoutQuery,
                                                            data, "pre_checkout_query");
  result->poll = tryParseJson<Poll>(&TgTypeParser::parseJsonAndGetPoll, data, "poll");
  result->pollAnswer =
      tryParseJson<PollAnswer>(&TgTypeParser::parseJsonAndGetPollAnswer, data, "poll_answer");
  result->myChatMember = tryParseJson<ChatMemberUpdated>(&TgTypeParser::parseJsonAndGetChatMemberUpdated,
                                                         data, "my_chat_member");
  result->chatMember =
      tryParseJson<ChatMemberUpdated>(&TgTypeParser::parseJsonAndGetChatMemberUpdated, data, "chat_member");
  result->chatJoinRequest =
      tryParseJson<ChatJoinRequest>(&TgTypeParser::parseJsonAndGetChatJoinRequest, data, "chat_join_request");
  result->chatBoost =
      tryParseJson<ChatBoostUpdated>(&TgTypeParser::parseJsonAndGetChatBoostUpdated, data, "chat_boost");
  result->removedChatBoost = tryParseJson<ChatBoostRemoved>(&TgTypeParser::parseJsonAndGetChatBoostRemoved,
...
std::string TgTypeParser::parseUpdate(const Update::Ptr& object) const {
  ...
  appendToJson(result, "deleted_business_messages",
               parseBusinessMessagesDeleted(object->deletedBusinessMessages));
  appendToJson(result, "message_reaction", parseMessageReactionUpdated(object->messageReaction));
  appendToJson(result, "message_reaction_count",
               parseMessageReactionCountUpdated(object->messageReactionCount));
...
std::string TgTypeParser::parseWebhookInfo(const WebhookInfo::Ptr& object) const {
  ...
  appendToJson(
      ...
      parseArray<std::string>([](const std::string& s) -> std::string { return s; }, object->allowedUpdates));
  removeLastComma(result);
  result += '}';
  return result;
}
...
Chat::Ptr TgTypeParser::parseJsonAndGetChat(const boost::property_tree::ptree& data) const {
  ...
  result->businessIntro =
      tryParseJson<BusinessIntro>(&TgTypeParser::parseJsonAndGetBusinessIntro, data, "business_intro");
  result->businessLocation = tryParseJson<BusinessLocation>(&TgTypeParser::parseJsonAndGetBusinessLocation,
                                                            data, "business_location");
  result->businessOpeningHours = tryParseJson<BusinessOpeningHours>(
      &TgTypeParser::parseJsonAndGetBusinessOpeningHours, data, "business_opening_hours");
  result->personalChat = tryParseJson<Chat>(&TgTypeParser::parseJsonAndGetChat, data, "personal_chat");
  result->availableReactions = parseJsonAndGetArray<ReactionType>(&TgTypeParser::parseJsonAndGetReactionType,
  ...
  result->pinnedMessage =
      tryParseJson<Message>(&TgTypeParser::parseJsonAndGetMessage, data, "pinned_message");
  result->permissions =
      tryParseJson<ChatPermissions>(&TgTypeParser::parseJsonAndGetChatPermissions, data, "permissions");
...
std::string TgTypeParser::parseChat(const Chat::Ptr& object) const {
  ...
  appendToJson(result, "active_usernames",
               parseArray<std::string>([](const std::string& s) -> std::string { return s; },
  ...
  appendToJson(result, "available_reactions",
               parseArray(&TgTypeParser::parseReactionType, object->availableReactions));
...
Message::Ptr TgTypeParser::parseJsonAndGetMessage(const boost::property_tree::ptree& data) const {
  ...
  result->senderBusinessBot =
      tryParseJson<User>(&TgTypeParser::parseJsonAndGetUser, data, "sender_business_bot");
  ...
  result->forwardOrigin =
      tryParseJson<MessageOrigin>(&TgTypeParser::parseJsonAndGetMessageOrigin, data, "forward_origin");
  ...
  result->replyToMessage =
      tryParseJson<Message>(&TgTypeParser::parseJsonAndGetMessage, data, "reply_to_message");
  result->externalReply = tryParseJson<ExternalReplyInfo>(&TgTypeParser::parseJsonAndGetExternalReplyInfo,
                                                          data, "external_reply");
  ...
  result->entities =
      parseJsonAndGetArray<MessageEntity>(&TgTypeParser::parseJsonAndGetMessageEntity, data, "entities");
  result->linkPreviewOptions = tryParseJson<LinkPreviewOptions>(
      &TgTypeParser::parseJsonAndGetLinkPreviewOptions, data, "link_preview_options");
  ...
  result->captionEntities = parseJsonAndGetArray<MessageEntity>(&TgTypeParser::parseJsonAndGetMessageEntity,
  ...
  result->newChatMembers =
      parseJsonAndGetArray<User>(&TgTypeParser::parseJsonAndGetUser, data, "new_chat_members");
  ...
  result->newChatPhoto =
      parseJsonAndGetArray<PhotoSize>(&TgTypeParser::parseJsonAndGetPhotoSize, data, "new_chat_photo");
  ...
  result->messageAutoDeleteTimerChanged = tryParseJson<MessageAutoDeleteTimerChanged>(
      &TgTypeParser::parseJsonAndGetMessageAutoDeleteTimerChanged, data, "message_auto_delete_timer_changed");
  ...
  result->successfulPayment = tryParseJson<SuccessfulPayment>(&TgTypeParser::parseJsonAndGetSuccessfulPayment,
                                                              data, "successful_payment");
  result->usersShared =
      tryParseJson<UsersShared>(&TgTypeParser::parseJsonAndGetUsersShared, data, "users_shared");
  result->chatShared =
      tryParseJson<ChatShared>(&TgTypeParser::parseJsonAndGetChatShared, data, "chat_shared");
  result->connectedWebsite = data.get<std::string>("connected_website", "");
  result->writeAccessAllowed = tryParseJson<WriteAccessAllowed>(
      &TgTypeParser::parseJsonAndGetWriteAccessAllowed, data, "write_access_allowed");
  result->passportData =
      tryParseJson<PassportData>(&TgTypeParser::parseJsonAndGetPassportData, data, "passport_data");
  result->proximityAlertTriggered = tryParseJson<ProximityAlertTriggered>(
      &TgTypeParser::parseJsonAndGetProximityAlertTriggered, data, "proximity_alert_triggered");
  result->boostAdded =
      tryParseJson<ChatBoostAdded>(&TgTypeParser::parseJsonAndGetChatBoostAdded, data, "boost_added");
  result->forumTopicCreated = tryParseJson<ForumTopicCreated>(&TgTypeParser::parseJsonAndGetForumTopicCreated,
                                                              data, "forum_topic_created");
  result->forumTopicEdited = tryParseJson<ForumTopicEdited>(&TgTypeParser::parseJsonAndGetForumTopicEdited,
                                                            data, "forum_topic_edited");
  result->forumTopicClosed = tryParseJson<ForumTopicClosed>(&TgTypeParser::parseJsonAndGetForumTopicClosed,
                                                            data, "forum_topic_closed");
  result->forumTopicReopened = tryParseJson<ForumTopicReopened>(
      &TgTypeParser::parseJsonAndGetForumTopicReopened, data, "forum_topic_reopened");
  result->generalForumTopicHidden = tryParseJson<GeneralForumTopicHidden>(
      &TgTypeParser::parseJsonAndGetGeneralForumTopicHidden, data, "general_forum_topic_hidden");
  result->generalForumTopicUnhidden = tryParseJson<GeneralForumTopicUnhidden>(
      &TgTypeParser::parseJsonAndGetGeneralForumTopicUnhidden, data, "general_forum_topic_unhidden");
  result->giveawayCreated =
      tryParseJson<GiveawayCreated>(&TgTypeParser::parseJsonAndGetGiveawayCreated, data, "giveaway_created");
  result->giveaway = tryParseJson<Giveaway>(&TgTypeParser::parseJsonAndGetGiveaway, data, "giveaway");
  result->giveawayWinners =
      tryParseJson<GiveawayWinners>(&TgTypeParser::parseJsonAndGetGiveawayWinners, data, "giveaway_winners");
  result->giveawayCompleted = tryParseJson<GiveawayCompleted>(&TgTypeParser::parseJsonAndGetGiveawayCompleted,
                                                              data, "giveaway_completed");
  result->videoChatScheduled = tryParseJson<VideoChatScheduled>(
      &TgTypeParser::parseJsonAndGetVideoChatScheduled, data, "video_chat_scheduled");
  result->videoChatStarted = tryParseJson<VideoChatStarted>(&TgTypeParser::parseJsonAndGetVideoChatStarted,
                                                            data, "video_chat_started");
  result->videoChatEnded =
      tryParseJson<VideoChatEnded>(&TgTypeParser::parseJsonAndGetVideoChatEnded, data, "video_chat_ended");
  result->videoChatParticipantsInvited = tryParseJson<VideoChatParticipantsInvited>(
      &TgTypeParser::parseJsonAndGetVideoChatParticipantsInvited, data, "video_chat_participants_invited");
  result->webAppData =
      tryParseJson<WebAppData>(&TgTypeParser::parseJsonAndGetWebAppData, data, "web_app_data");
  result->replyMarkup = tryParseJson<InlineKeyboardMarkup>(&TgTypeParser::parseJsonAndGetInlineKeyboardMarkup,
                                                           data, "reply_markup");
  return result;
}
...
std::string TgTypeParser::parseMessage(const Message::Ptr& object) const {
  ...
  appendToJson(result, "caption_entities",
               parseArray(&TgTypeParser::parseMessageEntity, object->captionEntities));
  ...
  appendToJson(result, "message_auto_delete_timer_changed",
               parseMessageAutoDeleteTimerChanged(object->messageAutoDeleteTimerChanged));
  ...
  appendToJson(result, "proximity_alert_triggered",
               parseProximityAlertTriggered(object->proximityAlertTriggered));
  ...
  appendToJson(result, "general_forum_topic_hidden",
               parseGeneralForumTopicHidden(object->generalForumTopicHidden));
  appendToJson(result, "general_forum_topic_unhidden",
               parseGeneralForumTopicUnhidden(object->generalForumTopicUnhidden));
  ...
  appendToJson(result, "video_chat_participants_invited",
               parseVideoChatParticipantsInvited(object->videoChatParticipantsInvited));
...
InaccessibleMessage::Ptr TgTypeParser::parseJsonAndGetInaccessibleMessage(
...
ExternalReplyInfo::Ptr TgTypeParser::parseJsonAndGetExternalReplyInfo(
    const boost::property_tree::ptree& data) const {
...
ReplyParameters::Ptr TgTypeParser::parseJsonAndGetReplyParameters(
    const boost::property_tree::ptree& data) const {
  ...
  result->quoteEntities = parseJsonAndGetArray<MessageEntity>(&TgTypeParser::parseJsonAndGetMessageEntity,
                                                              data, "quote_entities");
...
std::string TgTypeParser::parseReplyParameters(const ReplyParameters::Ptr& object) const {
  ...
  appendToJson(result, "quote_entities",
               parseArray(&TgTypeParser::parseMessageEntity, object->quoteEntities));
...
MessageOriginUser::Ptr TgTypeParser::parseJsonAndGetMessageOriginUser(
    const boost::property_tree::ptree& data) const {
...
MessageOriginHiddenUser::Ptr TgTypeParser::parseJsonAndGetMessageOriginHiddenUser(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetMessageOrigin().
...
MessageOriginChat::Ptr TgTypeParser::parseJsonAndGetMessageOriginChat(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetMessageOrigin().
...
MessageOriginChannel::Ptr TgTypeParser::parseJsonAndGetMessageOriginChannel(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetMessageOrigin().
...
std::string TgTypeParser::parsePollAnswer(const PollAnswer::Ptr& object) const {
  ...
  appendToJson(result, "user", parseUser(object->user));
  appendToJson(result, "option_ids",
               parseArray<std::int32_t>([](std::int32_t i) -> std::int32_t { return i; }, object->optionIds));
  removeLastComma(result);
  result += '}';
  return result;
}
...
Poll::Ptr TgTypeParser::parseJsonAndGetPoll(const boost::property_tree::ptree& data) const {
  ...
  result->options =
      parseJsonAndGetArray<PollOption>(&TgTypeParser::parseJsonAndGetPollOption, data, "options");
  ...
  result->explanationEntities = parseJsonAndGetArray<MessageEntity>(
      &TgTypeParser::parseJsonAndGetMessageEntity, data, "explanation_entities");
...
std::string TgTypeParser::parsePoll(const Poll::Ptr& object) const {
  ...
  appendToJson(result, "explanation_entities",
               parseArray(&TgTypeParser::parseMessageEntity, object->explanationEntities));
...
ProximityAlertTriggered::Ptr TgTypeParser::parseJsonAndGetProximityAlertTriggered(
    const boost::property_tree::ptree& data) const {
...
MessageAutoDeleteTimerChanged::Ptr TgTypeParser::parseJsonAndGetMessageAutoDeleteTimerChanged(
    const boost::property_tree::ptree& data) const {
...
std::string TgTypeParser::parseMessageAutoDeleteTimerChanged(
    const MessageAutoDeleteTimerChanged::Ptr& object) const {
  if (!object) {
    return "";
  }
  std::string result;
...
ChatBoostAdded::Ptr TgTypeParser::parseJsonAndGetChatBoostAdded(
    const boost::property_tree::ptree& data) const {
...
ForumTopicCreated::Ptr TgTypeParser::parseJsonAndGetForumTopicCreated(
    const boost::property_tree::ptree& data) const {
...
ForumTopicClosed::Ptr TgTypeParser::parseJsonAndGetForumTopicClosed(
    const boost::property_tree::ptree& /*data*/) const {
...
ForumTopicEdited::Ptr TgTypeParser::parseJsonAndGetForumTopicEdited(
    const boost::property_tree::ptree& data) const {
...
ForumTopicReopened::Ptr TgTypeParser::parseJsonAndGetForumTopicReopened(
    const boost::property_tree::ptree& /*data*/) const {
...
GeneralForumTopicHidden::Ptr TgTypeParser::parseJsonAndGetGeneralForumTopicHidden(
    const boost::property_tree::ptree& /*data*/) const {
...
GeneralForumTopicUnhidden::Ptr TgTypeParser::parseJsonAndGetGeneralForumTopicUnhidden(
    const boost::property_tree::ptree& /*data*/) const {
...
WriteAccessAllowed::Ptr TgTypeParser::parseJsonAndGetWriteAccessAllowed(
    const boost::property_tree::ptree& data) const {
...
VideoChatScheduled::Ptr TgTypeParser::parseJsonAndGetVideoChatScheduled(
    const boost::property_tree::ptree& data) const {
...
VideoChatStarted::Ptr TgTypeParser::parseJsonAndGetVideoChatStarted(
    const boost::property_tree::ptree& /*data*/) const {
...
VideoChatEnded::Ptr TgTypeParser::parseJsonAndGetVideoChatEnded(
    const boost::property_tree::ptree& data) const {
...
VideoChatParticipantsInvited::Ptr TgTypeParser::parseJsonAndGetVideoChatParticipantsInvited(
    const boost::property_tree::ptree& data) const {
...
std::string TgTypeParser::parseVideoChatParticipantsInvited(
    const VideoChatParticipantsInvited::Ptr& object) const {
  if (!object) {
    return "";
  }
  std::string result;
...
GiveawayCreated::Ptr TgTypeParser::parseJsonAndGetGiveawayCreated(
    const boost::property_tree::ptree& /*data*/) const {
...
std::string TgTypeParser::parseGiveaway(const Giveaway::Ptr& object) const {
  ...
  appendToJson(
      ...
      parseArray<std::string>([](const std::string& s) -> std::string { return s; }, object->countryCodes));
...
GiveawayWinners::Ptr TgTypeParser::parseJsonAndGetGiveawayWinners(
    const boost::property_tree::ptree& data) const {
...
GiveawayCompleted::Ptr TgTypeParser::parseJsonAndGetGiveawayCompleted(
    const boost::property_tree::ptree& data) const {
  auto result(std::make_shared<GiveawayCompleted>());
  result->winnerCount = data.get<std::int32_t>("winner_count", 0);
  result->unclaimedPrizeCount = data.get<std::int32_t>("unclaimed_prize_count", 0);
  result->giveawayMessage =
      tryParseJson<Message>(&TgTypeParser::parseJsonAndGetMessage, data, "giveaway_message");
  return result;
}
...
LinkPreviewOptions::Ptr TgTypeParser::parseJsonAndGetLinkPreviewOptions(
    const boost::property_tree::ptree& data) const {
...
UserProfilePhotos::Ptr TgTypeParser::parseJsonAndGetUserProfilePhotos(
    const boost::property_tree::ptree& data) const {
...
ReplyKeyboardMarkup::Ptr TgTypeParser::parseJsonAndGetReplyKeyboardMarkup(
    const boost::property_tree::ptree& data) const {
  auto result(std::make_shared<ReplyKeyboardMarkup>());
  for (const auto& item : data.find("keyboard")->second) {
    result->keyboard.push_back(
        parseJsonAndGetArray<KeyboardButton>(&TgTypeParser::parseJsonAndGetKeyboardButton, item.second));
  }
...
KeyboardButton::Ptr TgTypeParser::parseJsonAndGetKeyboardButton(
    const boost::property_tree::ptree& data) const {
  auto result(std::make_shared<KeyboardButton>());
  result->text = data.get<std::string>("text", "");
  result->requestUsers = tryParseJson<KeyboardButtonRequestUsers>(
      &TgTypeParser::parseJsonAndGetKeyboardButtonRequestUsers, data, "request_users");
  result->requestChat = tryParseJson<KeyboardButtonRequestChat>(
      &TgTypeParser::parseJsonAndGetKeyboardButtonRequestChat, data, "request_chat");
  result->requestContact = data.get<bool>("request_contact", false);
  result->requestLocation = data.get<bool>("request_location", false);
  result->requestPoll = tryParseJson<KeyboardButtonPollType>(
      &TgTypeParser::parseJsonAndGetKeyboardButtonPollType, data, "request_poll");
...
KeyboardButtonRequestUsers::Ptr TgTypeParser::parseJsonAndGetKeyboardButtonRequestUsers(
    const boost::property_tree::ptree& data) const {
...
std::string TgTypeParser::parseKeyboardButtonRequestUsers(
    const KeyboardButtonRequestUsers::Ptr& object) const {
  if (!object) {
    return "";
  }
  std::string result;
...
KeyboardButtonRequestChat::Ptr TgTypeParser::parseJsonAndGetKeyboardButtonRequestChat(
    const boost::property_tree::ptree& data) const {
  ...
  result->userAdministratorRights = tryParseJson<ChatAdministratorRights>(
      &TgTypeParser::parseJsonAndGetChatAdministratorRights, data, "user_administrator_rights");
  result->botAdministratorRights = tryParseJson<ChatAdministratorRights>(
      &TgTypeParser::parseJsonAndGetChatAdministratorRights, data, "bot_administrator_rights");
...
std::string TgTypeParser::parseKeyboardButtonRequestChat(const KeyboardButtonRequestChat::Ptr& object) const {
  ...
  appendToJson(result, "user_administrator_rights",
               parseChatAdministratorRights(object->userAdministratorRights));
  appendToJson(result, "bot_administrator_rights",
               parseChatAdministratorRights(object->botAdministratorRights));
...
KeyboardButtonPollType::Ptr TgTypeParser::parseJsonAndGetKeyboardButtonPollType(
    const boost::property_tree::ptree& data) const {
...
ReplyKeyboardRemove::Ptr TgTypeParser::parseJsonAndGetReplyKeyboardRemove(
    const boost::property_tree::ptree& data) const {
...
InlineKeyboardMarkup::Ptr TgTypeParser::parseJsonAndGetInlineKeyboardMarkup(
    const boost::property_tree::ptree& data) const {
  auto result(std::make_shared<InlineKeyboardMarkup>());
  for (const auto& item : data.find("inline_keyboard")->second) {
    result->inlineKeyboard.push_back(parseJsonAndGetArray<InlineKeyboardButton>(
        &TgTypeParser::parseJsonAndGetInlineKeyboardButton, item.second));
  }
  return result;
}
...
InlineKeyboardButton::Ptr TgTypeParser::parseJsonAndGetInlineKeyboardButton(
  ...
  result->switchInlineQueryChosenChat = tryParseJson<SwitchInlineQueryChosenChat>(
      &TgTypeParser::parseJsonAndGetSwitchInlineQueryChosenChat, data, "switch_inline_query_chosen_chat");
  result->callbackGame =
      tryParseJson<CallbackGame>(&TgTypeParser::parseJsonAndGetCallbackGame, data, "callback_game");
...
std::string TgTypeParser::parseInlineKeyboardButton(const InlineKeyboardButton::Ptr& object) const {
  ...
  appendToJson(result, "switch_inline_query_chosen_chat",
               parseSwitchInlineQueryChosenChat(object->switchInlineQueryChosenChat));
...
SwitchInlineQueryChosenChat::Ptr TgTypeParser::parseJsonAndGetSwitchInlineQueryChosenChat(
    const boost::property_tree::ptree& data) const {
...
std::string TgTypeParser::parseSwitchInlineQueryChosenChat(
    const SwitchInlineQueryChosenChat::Ptr& object) const {
  if (!object) {
    return "";
  }
  std::string result;
...
ChatInviteLink::Ptr TgTypeParser::parseJsonAndGetChatInviteLink(
    const boost::property_tree::ptree& data) const {
...
ChatAdministratorRights::Ptr TgTypeParser::parseJsonAndGetChatAdministratorRights(
    const boost::property_tree::ptree& data) const {
...
ChatMemberUpdated::Ptr TgTypeParser::parseJsonAndGetChatMemberUpdated(
    const boost::property_tree::ptree& data) const {
  auto result(std::make_shared<ChatMemberUpdated>());
  result->chat = tryParseJson<Chat>(&TgTypeParser::parseJsonAndGetChat, data, "chat");
  result->from = tryParseJson<User>(&TgTypeParser::parseJsonAndGetUser, data, "from");
  result->date = data.get<std::uint32_t>("date", 0);
  result->oldChatMember =
      tryParseJson<ChatMember>(&TgTypeParser::parseJsonAndGetChatMember, data, "old_chat_member");
  result->newChatMember =
      tryParseJson<ChatMember>(&TgTypeParser::parseJsonAndGetChatMember, data, "new_chat_member");
  result->inviteLink =
      tryParseJson<ChatInviteLink>(&TgTypeParser::parseJsonAndGetChatInviteLink, data, "invite_link");
...
ChatMemberOwner::Ptr TgTypeParser::parseJsonAndGetChatMemberOwner(
    const boost::property_tree::ptree& data) const {
...
ChatMemberAdministrator::Ptr TgTypeParser::parseJsonAndGetChatMemberAdministrator(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetChatMember().
...
ChatMemberMember::Ptr TgTypeParser::parseJsonAndGetChatMemberMember(
    const boost::property_tree::ptree& /*data*/) const {
  // NOTE: This function will be called by parseJsonAndGetChatMember().
...
ChatMemberRestricted::Ptr TgTypeParser::parseJsonAndGetChatMemberRestricted(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetChatMember().
...
ChatMemberLeft::Ptr TgTypeParser::parseJsonAndGetChatMemberLeft(
    const boost::property_tree::ptree& /*data*/) const {
  // NOTE: This function will be called by parseJsonAndGetChatMember().
...
ChatMemberBanned::Ptr TgTypeParser::parseJsonAndGetChatMemberBanned(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetChatMember().
...
ChatJoinRequest::Ptr TgTypeParser::parseJsonAndGetChatJoinRequest(
    const boost::property_tree::ptree& data) const {
...
ChatPermissions::Ptr TgTypeParser::parseJsonAndGetChatPermissions(
    const boost::property_tree::ptree& data) const {
...
BusinessLocation::Ptr TgTypeParser::parseJsonAndGetBusinessLocation(
    const boost::property_tree::ptree& data) const {
...
BusinessOpeningHoursInterval::Ptr TgTypeParser::parseJsonAndGetBusinessOpeningHoursInterval(
    const boost::property_tree::ptree& data) const {
...
std::string TgTypeParser::parseBusinessOpeningHoursInterval(
    const BusinessOpeningHoursInterval::Ptr& object) const {
  if (!object) {
    return "";
  }
  std::string result;
...
BusinessOpeningHours::Ptr TgTypeParser::parseJsonAndGetBusinessOpeningHours(
    const boost::property_tree::ptree& data) const {
  auto result(std::make_shared<BusinessOpeningHours>());
  result->timeZoneName = data.get<std::string>("time_zone_name", "");
  result->openingHours = parseJsonAndGetArray<BusinessOpeningHoursInterval>(
      &TgTypeParser::parseJsonAndGetBusinessOpeningHoursInterval, data, "opening_hours");
  return result;
}
...
std::string TgTypeParser::parseBusinessOpeningHours(const BusinessOpeningHours::Ptr& object) const {
  ...
  appendToJson(result, "opening_hours",
               parseArray(&TgTypeParser::parseBusinessOpeningHoursInterval, object->openingHours));
  removeLastComma(result);
  result += '}';
  return result;
}
...
ReactionTypeEmoji::Ptr TgTypeParser::parseJsonAndGetReactionTypeEmoji(
    const boost::property_tree::ptree& data) const {
...
ReactionTypeCustomEmoji::Ptr TgTypeParser::parseJsonAndGetReactionTypeCustomEmoji(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetReactionType().
...
MessageReactionUpdated::Ptr TgTypeParser::parseJsonAndGetMessageReactionUpdated(
    const boost::property_tree::ptree& data) const {
  ...
  result->date = data.get<std::uint32_t>("date", 0);
  result->oldReaction =
      parseJsonAndGetArray<ReactionType>(&TgTypeParser::parseJsonAndGetReactionType, data, "old_reaction");
  result->newReaction =
      parseJsonAndGetArray<ReactionType>(&TgTypeParser::parseJsonAndGetReactionType, data, "new_reaction");
  return result;
}
...
MessageReactionCountUpdated::Ptr TgTypeParser::parseJsonAndGetMessageReactionCountUpdated(
    const boost::property_tree::ptree& data) const {
  ...
  result->date = data.get<std::uint32_t>("date", 0);
  result->reactions =
      parseJsonAndGetArray<ReactionCount>(&TgTypeParser::parseJsonAndGetReactionCount, data, "reactions");
  return result;
}

std::string TgTypeParser::parseMessageReactionCountUpdated(
    const MessageReactionCountUpdated::Ptr& object) const {
  if (!object) {
    return "";
  }
  std::string result;
...
BotCommandScope::Ptr TgTypeParser::parseJsonAndGetBotCommandScope(
    const boost::property_tree::ptree& data) const {
  std::string type = data.get<std::string>("type", "");
  ...
  if (type == BotCommandScopeDefault::TYPE) {
    ...
    result =
        std::static_pointer_cast<BotCommandScope>(parseJsonAndGetBotCommandScopeAllChatAdministrators(data));
    ...
    result =
        std::static_pointer_cast<BotCommandScope>(parseJsonAndGetBotCommandScopeChatAdministrators(data));
...
std::string TgTypeParser::parseBotCommandScope(const BotCommandScope::Ptr& object) const {
  ...
  if (object->type == BotCommandScopeDefault::TYPE) {
    ...
    result +=
        parseBotCommandScopeAllPrivateChats(std::static_pointer_cast<BotCommandScopeAllPrivateChats>(object));
  } else if (object->type == BotCommandScopeAllGroupChats::TYPE) {
    result +=
        parseBotCommandScopeAllGroupChats(std::static_pointer_cast<BotCommandScopeAllGroupChats>(object));
  } else if (object->type == BotCommandScopeAllChatAdministrators::TYPE) {
    result += parseBotCommandScopeAllChatAdministrators(
        std::static_pointer_cast<BotCommandScopeAllChatAdministrators>(object));
    ...
    result += parseBotCommandScopeChatAdministrators(
        std::static_pointer_cast<BotCommandScopeChatAdministrators>(object));
...
BotCommandScopeDefault::Ptr TgTypeParser::parseJsonAndGetBotCommandScopeDefault(
    const boost::property_tree::ptree& /*data*/) const {
...
BotCommandScopeAllPrivateChats::Ptr TgTypeParser::parseJsonAndGetBotCommandScopeAllPrivateChats(
    const boost::property_tree::ptree& /*data*/) const {
  // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
...
std::string TgTypeParser::parseBotCommandScopeAllPrivateChats(
    const BotCommandScopeAllPrivateChats::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseBotCommandScope(), so I don't add
...
BotCommandScopeAllGroupChats::Ptr TgTypeParser::parseJsonAndGetBotCommandScopeAllGroupChats(
    const boost::property_tree::ptree& /*data*/) const {
  // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
...
std::string TgTypeParser::parseBotCommandScopeAllGroupChats(
    const BotCommandScopeAllGroupChats::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseBotCommandScope(), so I don't add
...
BotCommandScopeAllChatAdministrators::Ptr TgTypeParser::parseJsonAndGetBotCommandScopeAllChatAdministrators(
    const boost::property_tree::ptree& /*data*/) const {
  // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
...
std::string TgTypeParser::parseBotCommandScopeAllChatAdministrators(
...
BotCommandScopeChat::Ptr TgTypeParser::parseJsonAndGetBotCommandScopeChat(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
...
BotCommandScopeChatAdministrators::Ptr TgTypeParser::parseJsonAndGetBotCommandScopeChatAdministrators(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
...
std::string TgTypeParser::parseBotCommandScopeChatAdministrators(
...
BotCommandScopeChatMember::Ptr TgTypeParser::parseJsonAndGetBotCommandScopeChatMember(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
...
BotDescription::Ptr TgTypeParser::parseJsonAndGetBotDescription(
    const boost::property_tree::ptree& data) const {
...
BotShortDescription::Ptr TgTypeParser::parseJsonAndGetBotShortDescription(
    const boost::property_tree::ptree& data) const {
...
MenuButtonCommands::Ptr TgTypeParser::parseJsonAndGetMenuButtonCommands(
    const boost::property_tree::ptree& /*data*/) const {
...
MenuButtonWebApp::Ptr TgTypeParser::parseJsonAndGetMenuButtonWebApp(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetMenuButton().
...
MenuButtonDefault::Ptr TgTypeParser::parseJsonAndGetMenuButtonDefault(
    const boost::property_tree::ptree& /*data*/) const {
  // NOTE: This function will be called by parseJsonAndGetMenuButton().
...
ChatBoostSource::Ptr TgTypeParser::parseJsonAndGetChatBoostSource(
    const boost::property_tree::ptree& data) const {
...
ChatBoostSourcePremium::Ptr TgTypeParser::parseJsonAndGetChatBoostSourcePremium(
    const boost::property_tree::ptree& /*data*/) const {
...
ChatBoostSourceGiftCode::Ptr TgTypeParser::parseJsonAndGetChatBoostSourceGiftCode(
    const boost::property_tree::ptree& /*data*/) const {
  // NOTE: This function will be called by parseJsonAndGetChatBoostSource().
...
ChatBoostSourceGiveaway::Ptr TgTypeParser::parseJsonAndGetChatBoostSourceGiveaway(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetChatBoostSource().
...
ChatBoost::Ptr TgTypeParser::parseJsonAndGetChatBoost(const boost::property_tree::ptree& data) const {
  ...
  result->source =
      tryParseJson<ChatBoostSource>(&TgTypeParser::parseJsonAndGetChatBoostSource, data, "source");
  return result;
}
...
ChatBoostUpdated::Ptr TgTypeParser::parseJsonAndGetChatBoostUpdated(
    const boost::property_tree::ptree& data) const {
...
ChatBoostRemoved::Ptr TgTypeParser::parseJsonAndGetChatBoostRemoved(
    const boost::property_tree::ptree& data) const {
...
UserChatBoosts::Ptr TgTypeParser::parseJsonAndGetUserChatBoosts(
    const boost::property_tree::ptree& data) const {
...
BusinessConnection::Ptr TgTypeParser::parseJsonAndGetBusinessConnection(
    const boost::property_tree::ptree& data) const {
...
BusinessMessagesDeleted::Ptr TgTypeParser::parseJsonAndGetBusinessMessagesDeleted(
    const boost::property_tree::ptree& data) const {
...
std::string TgTypeParser::parseBusinessMessagesDeleted(const BusinessMessagesDeleted::Ptr& object) const {
  ...
  appendToJson(
      result, "message_ids",
      parseArray<std::int32_t>([](std::int32_t i) -> std::int32_t { return i; }, object->messageIds));
  removeLastComma(result);
  result += '}';
  return result;
}

ResponseParameters::Ptr TgTypeParser::parseJsonAndGetResponseParameters(
    const boost::property_tree::ptree& data) const {
...
InputMediaPhoto::Ptr TgTypeParser::parseJsonAndGetInputMediaPhoto(
    const boost::property_tree::ptree& data) const {
...
InputMediaVideo::Ptr TgTypeParser::parseJsonAndGetInputMediaVideo(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInputMedia().
...
InputMediaAnimation::Ptr TgTypeParser::parseJsonAndGetInputMediaAnimation(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInputMedia().
...
InputMediaAudio::Ptr TgTypeParser::parseJsonAndGetInputMediaAudio(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInputMedia().
...
InputMediaDocument::Ptr TgTypeParser::parseJsonAndGetInputMediaDocument(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInputMedia().
...
Sticker::Ptr TgTypeParser::parseJsonAndGetSticker(const boost::property_tree::ptree& data) const {
  ...
  result->premiumAnimation =
      tryParseJson<File>(&TgTypeParser::parseJsonAndGetFile, data, "premium_animation");
  result->maskPosition =
      tryParseJson<MaskPosition>(&TgTypeParser::parseJsonAndGetMaskPosition, data, "mask_position");
  result->customEmojiId = data.get<std::string>("custom_emoji_id", "");
...
std::string TgTypeParser::parseInputSticker(const InputSticker::Ptr& object) const {
  ...
  appendToJson(
      result, "emoji_list",
      parseArray<std::string>([](const std::string& s) -> std::string { return s; }, object->emojiList));
  appendToJson(result, "mask_position", parseMaskPosition(object->maskPosition));
  appendToJson(
      result, "keywords",
      parseArray<std::string>([](const std::string& s) -> std::string { return s; }, object->keywords));
  removeLastComma(result);
  result += '}';
  return result;
}
...
InlineQueryResultsButton::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultsButton(
    const boost::property_tree::ptree& data) const {
...
InlineQueryResult::Ptr TgTypeParser::parseJsonAndGetInlineQueryResult(
    const boost::property_tree::ptree& data) const {
  std::string type = data.get<std::string>("type", "");
  ...
  if (type == InlineQueryResultCachedAudio::TYPE) {
    ...
    result =
        std::static_pointer_cast<InlineQueryResult>(parseJsonAndGetInlineQueryResultCachedDocument(data));
    ...
    result =
        std::static_pointer_cast<InlineQueryResult>(parseJsonAndGetInlineQueryResultCachedMpeg4Gif(data));
...
std::string TgTypeParser::parseInlineQueryResult(const InlineQueryResult::Ptr& object) const {
  ...
  if (object->type == InlineQueryResultCachedAudio::TYPE) {
    result +=
        parseInlineQueryResultCachedAudio(std::static_pointer_cast<InlineQueryResultCachedAudio>(object));
  } else if (object->type == InlineQueryResultCachedDocument::TYPE) {
    result += parseInlineQueryResultCachedDocument(
        std::static_pointer_cast<InlineQueryResultCachedDocument>(object));
    ...
    result += parseInlineQueryResultCachedMpeg4Gif(
        std::static_pointer_cast<InlineQueryResultCachedMpeg4Gif>(object));
  } else if (object->type == InlineQueryResultCachedPhoto::TYPE) {
    result +=
        parseInlineQueryResultCachedPhoto(std::static_pointer_cast<InlineQueryResultCachedPhoto>(object));
  } else if (object->type == InlineQueryResultCachedSticker::TYPE) {
    result +=
        parseInlineQueryResultCachedSticker(std::static_pointer_cast<InlineQueryResultCachedSticker>(object));
  } else if (object->type == InlineQueryResultCachedVideo::TYPE) {
    result +=
        parseInlineQueryResultCachedVideo(std::static_pointer_cast<InlineQueryResultCachedVideo>(object));
  } else if (object->type == InlineQueryResultCachedVoice::TYPE) {
    result +=
        parseInlineQueryResultCachedVoice(std::static_pointer_cast<InlineQueryResultCachedVoice>(object));
...
InlineQueryResultArticle::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultArticle(
    const boost::property_tree::ptree& data) const {
  ...
  result->title = data.get<std::string>("title", "");
  result->inputMessageContent = tryParseJson<InputMessageContent>(
      &TgTypeParser::parseJsonAndGetInputMessageContent, data, "input_message_content");
  result->url = data.get<std::string>("url", "");
...
InlineQueryResultPhoto::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultPhoto(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
InlineQueryResultGif::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultGif(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
InlineQueryResultMpeg4Gif::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultMpeg4Gif(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
InlineQueryResultVideo::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultVideo(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
InlineQueryResultAudio::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultAudio(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
InlineQueryResultVoice::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultVoice(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
InlineQueryResultDocument::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultDocument(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
InlineQueryResultLocation::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultLocation(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
InlineQueryResultVenue::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultVenue(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
InlineQueryResultContact::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultContact(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
InlineQueryResultGame::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultGame(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
InlineQueryResultCachedPhoto::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultCachedPhoto(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
std::string TgTypeParser::parseInlineQueryResultCachedPhoto(
    const InlineQueryResultCachedPhoto::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseInlineQueryResult(), so I don't add
...
InlineQueryResultCachedGif::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultCachedGif(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
std::string TgTypeParser::parseInlineQueryResultCachedGif(
    const InlineQueryResultCachedGif::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseInlineQueryResult(), so I don't add
...
InlineQueryResultCachedMpeg4Gif::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultCachedMpeg4Gif(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
std::string TgTypeParser::parseInlineQueryResultCachedMpeg4Gif(
    const InlineQueryResultCachedMpeg4Gif::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseInlineQueryResult(), so I don't add
...
InlineQueryResultCachedSticker::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultCachedSticker(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
std::string TgTypeParser::parseInlineQueryResultCachedSticker(
    const InlineQueryResultCachedSticker::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseInlineQueryResult(), so I don't add
...
InlineQueryResultCachedDocument::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultCachedDocument(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
std::string TgTypeParser::parseInlineQueryResultCachedDocument(
    const InlineQueryResultCachedDocument::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseInlineQueryResult(), so I don't add
...
InlineQueryResultCachedVideo::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultCachedVideo(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
std::string TgTypeParser::parseInlineQueryResultCachedVideo(
    const InlineQueryResultCachedVideo::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseInlineQueryResult(), so I don't add
...
InlineQueryResultCachedVoice::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultCachedVoice(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
std::string TgTypeParser::parseInlineQueryResultCachedVoice(
    const InlineQueryResultCachedVoice::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseInlineQueryResult(), so I don't add
...
InlineQueryResultCachedAudio::Ptr TgTypeParser::parseJsonAndGetInlineQueryResultCachedAudio(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
...
std::string TgTypeParser::parseInlineQueryResultCachedAudio(
    const InlineQueryResultCachedAudio::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseInlineQueryResult(), so I don't add
...
InputMessageContent::Ptr TgTypeParser::parseJsonAndGetInputMessageContent(
    const boost::property_tree::ptree& data) const {
...
InputTextMessageContent::Ptr TgTypeParser::parseJsonAndGetInputTextMessageContent(
    const boost::property_tree::ptree& data) const {
...
InputLocationMessageContent::Ptr TgTypeParser::parseJsonAndGetInputLocationMessageContent(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInputMessageContent().
...
std::string TgTypeParser::parseInputLocationMessageContent(
    const InputLocationMessageContent::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseInputMessageContent()
...
InputVenueMessageContent::Ptr TgTypeParser::parseJsonAndGetInputVenueMessageContent(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInputMessageContent().
...
InputContactMessageContent::Ptr TgTypeParser::parseJsonAndGetInputContactMessageContent(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInputMessageContent().
...
std::string TgTypeParser::parseInputContactMessageContent(
    const InputContactMessageContent::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseInputMessageContent()
...
InputInvoiceMessageContent::Ptr TgTypeParser::parseJsonAndGetInputInvoiceMessageContent(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetInputMessageContent().
  ...
  result->prices =
      parseJsonAndGetArray<LabeledPrice>(&TgTypeParser::parseJsonAndGetLabeledPrice, data, "prices");
...
std::string TgTypeParser::parseInputInvoiceMessageContent(
    const InputInvoiceMessageContent::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parseInputMessageContent()
  ...
  appendToJson(result, "suggested_tip_amounts",
               parseArray<std::int32_t>([](std::int32_t i) -> std::int32_t { return i; },
...
ChosenInlineResult::Ptr TgTypeParser::parseJsonAndGetChosenInlineResult(
    const boost::property_tree::ptree& data) const {
...
SentWebAppMessage::Ptr TgTypeParser::parseJsonAndGetSentWebAppMessage(
    const boost::property_tree::ptree& data) const {
...
ShippingAddress::Ptr TgTypeParser::parseJsonAndGetShippingAddress(
    const boost::property_tree::ptree& data) const {
...
OrderInfo::Ptr TgTypeParser::parseJsonAndGetOrderInfo(const boost::property_tree::ptree& data) const {
  ...
  result->shippingAddress =
      tryParseJson<ShippingAddress>(&TgTypeParser::parseJsonAndGetShippingAddress, data, "shipping_address");
  return result;
}
...
ShippingOption::Ptr TgTypeParser::parseJsonAndGetShippingOption(
    const boost::property_tree::ptree& data) const {
...
SuccessfulPayment::Ptr TgTypeParser::parseJsonAndGetSuccessfulPayment(
    const boost::property_tree::ptree& data) const {
...
PreCheckoutQuery::Ptr TgTypeParser::parseJsonAndGetPreCheckoutQuery(
    const boost::property_tree::ptree& data) const {
...
PassportData::Ptr TgTypeParser::parseJsonAndGetPassportData(const boost::property_tree::ptree& data) const {
  ...
  result->data = parseJsonAndGetArray<EncryptedPassportElement>(
      &TgTypeParser::parseJsonAndGetEncryptedPassportElement, data, "data");
  result->credentials = tryParseJson<EncryptedCredentials>(&TgTypeParser::parseJsonAndGetEncryptedCredentials,
                                                           data, "credentials");
  return result;
}
...
EncryptedPassportElement::Ptr TgTypeParser::parseJsonAndGetEncryptedPassportElement(
    const boost::property_tree::ptree& data) const {
  ...
  result->email = data.get<std::string>("email", "");
  result->files =
      parseJsonAndGetArray<PassportFile>(&TgTypeParser::parseJsonAndGetPassportFile, data, "files");
  result->frontSide =
      tryParseJson<PassportFile>(&TgTypeParser::parseJsonAndGetPassportFile, data, "front_side");
  result->reverseSide =
      tryParseJson<PassportFile>(&TgTypeParser::parseJsonAndGetPassportFile, data, "reverse_side");
  result->selfie = tryParseJson<PassportFile>(&TgTypeParser::parseJsonAndGetPassportFile, data, "selfie");
  result->translation =
      parseJsonAndGetArray<PassportFile>(&TgTypeParser::parseJsonAndGetPassportFile, data, "translation");
...
EncryptedCredentials::Ptr TgTypeParser::parseJsonAndGetEncryptedCredentials(
    const boost::property_tree::ptree& data) const {
...
PassportElementError::Ptr TgTypeParser::parseJsonAndGetPassportElementError(
    const boost::property_tree::ptree& data) const {
  std::string source = data.get<std::string>("source", "");
  ...
  if (source == PassportElementErrorDataField::SOURCE) {
    result =
        std::static_pointer_cast<PassportElementError>(parseJsonAndGetPassportElementErrorDataField(data));
  } else if (source == PassportElementErrorFrontSide::SOURCE) {
    result =
        std::static_pointer_cast<PassportElementError>(parseJsonAndGetPassportElementErrorFrontSide(data));
  } else if (source == PassportElementErrorReverseSide::SOURCE) {
    result =
        std::static_pointer_cast<PassportElementError>(parseJsonAndGetPassportElementErrorReverseSide(data));
    ...
    result = std::static_pointer_cast<PassportElementError>(
        parseJsonAndGetPassportElementErrorTranslationFile(data));
  } else if (source == PassportElementErrorTranslationFiles::SOURCE) {
    result = std::static_pointer_cast<PassportElementError>(
        parseJsonAndGetPassportElementErrorTranslationFiles(data));
  } else if (source == PassportElementErrorUnspecified::SOURCE) {
    result =
        std::static_pointer_cast<PassportElementError>(parseJsonAndGetPassportElementErrorUnspecified(data));
  } else {
...
std::string TgTypeParser::parsePassportElementError(const PassportElementError::Ptr& object) const {
  ...
  if (object->source == PassportElementErrorDataField::SOURCE) {
    result +=
        parsePassportElementErrorDataField(std::static_pointer_cast<PassportElementErrorDataField>(object));
  } else if (object->source == PassportElementErrorFrontSide::SOURCE) {
    result +=
        parsePassportElementErrorFrontSide(std::static_pointer_cast<PassportElementErrorFrontSide>(object));
  } else if (object->source == PassportElementErrorReverseSide::SOURCE) {
    result += parsePassportElementErrorReverseSide(
        std::static_pointer_cast<PassportElementErrorReverseSide>(object));
    ...
    result += parsePassportElementErrorTranslationFile(
        std::static_pointer_cast<PassportElementErrorTranslationFile>(object));
  } else if (object->source == PassportElementErrorTranslationFiles::SOURCE) {
    result += parsePassportElementErrorTranslationFiles(
        std::static_pointer_cast<PassportElementErrorTranslationFiles>(object));
  } else if (object->source == PassportElementErrorUnspecified::SOURCE) {
    result += parsePassportElementErrorUnspecified(
        std::static_pointer_cast<PassportElementErrorUnspecified>(object));
  }
...
PassportElementErrorDataField::Ptr TgTypeParser::parseJsonAndGetPassportElementErrorDataField(
    const boost::property_tree::ptree& data) const {
...
std::string TgTypeParser::parsePassportElementErrorDataField(
    const PassportElementErrorDataField::Ptr& object) const {
  if (!object) {
    return "";
  }
...
PassportElementErrorFrontSide::Ptr TgTypeParser::parseJsonAndGetPassportElementErrorFrontSide(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetPassportElementError().
...
std::string TgTypeParser::parsePassportElementErrorFrontSide(
    const PassportElementErrorFrontSide::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parsePassportElementError(), so I don't add
...
PassportElementErrorReverseSide::Ptr TgTypeParser::parseJsonAndGetPassportElementErrorReverseSide(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetPassportElementError().
...
std::string TgTypeParser::parsePassportElementErrorReverseSide(
    const PassportElementErrorReverseSide::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parsePassportElementError(), so I don't add
...
PassportElementErrorSelfie::Ptr TgTypeParser::parseJsonAndGetPassportElementErrorSelfie(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetPassportElementError().
...
std::string TgTypeParser::parsePassportElementErrorSelfie(
    const PassportElementErrorSelfie::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parsePassportElementError(), so I don't add
...
PassportElementErrorFile::Ptr TgTypeParser::parseJsonAndGetPassportElementErrorFile(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetPassportElementError().
...
PassportElementErrorFiles::Ptr TgTypeParser::parseJsonAndGetPassportElementErrorFiles(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetPassportElementError().
...
std::string TgTypeParser::parsePassportElementErrorFiles(const PassportElementErrorFiles::Ptr& object) const {
  ...
  appendToJson(
      result, "file_hashes",
      parseArray<std::string>([](const std::string& s) -> std::string { return s; }, object->fileHashes));
  // The last comma will be erased by parsePassportElementError().
  return result;
}

PassportElementErrorTranslationFile::Ptr TgTypeParser::parseJsonAndGetPassportElementErrorTranslationFile(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetPassportElementError().
...
std::string TgTypeParser::parsePassportElementErrorTranslationFile(
...
PassportElementErrorTranslationFiles::Ptr TgTypeParser::parseJsonAndGetPassportElementErrorTranslationFiles(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetPassportElementError().
...
std::string TgTypeParser::parsePassportElementErrorTranslationFiles(
...
PassportElementErrorUnspecified::Ptr TgTypeParser::parseJsonAndGetPassportElementErrorUnspecified(
    const boost::property_tree::ptree& data) const {
  // NOTE: This function will be called by parseJsonAndGetPassportElementError().
...
std::string TgTypeParser::parsePassportElementErrorUnspecified(
    const PassportElementErrorUnspecified::Ptr& object) const {
  if (!object) {
    return "";
  }
  // This function will be called by parsePassportElementError(), so I don't add
...
Game::Ptr TgTypeParser::parseJsonAndGetGame(const boost::property_tree::ptree& data) const {
  ...
  result->text = data.get<std::string>("text", "");
  result->textEntities =
      parseJsonAndGetArray<MessageEntity>(&TgTypeParser::parseJsonAndGetMessageEntity, data, "text_entities");
  result->animation = tryParseJson<Animation>(&TgTypeParser::parseJsonAndGetAnimation, data, "animation");
  return result;
}
...
CallbackGame::Ptr TgTypeParser::parseJsonAndGetCallbackGame(
    const boost::property_tree::ptree& /*data*/) const {
...
void TgTypeParser::appendToJson(std::string& json, const std::string& varName,
